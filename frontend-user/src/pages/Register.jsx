...
export default function Register() {
  ...
  // ✅ ONLY Register with VexaAccount (SSO)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-dark-bg p-4">
      <div className="glass-card max-w-md w-full p-6 relative overflow-hidden">
        ...
        {/* ✅ ONLY Register with VexaAccount SSO Button */}
        <button
        ...
        <div className="mt-8 rounded-2xl border border-white/10 bg-white/[0.03] p-4">
          <div className="text-xs uppercase tracking-wider text-slate-500">Account Setup</div>
